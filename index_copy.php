...
/* Column Widths */
.table th:nth-child(1) { min-width: 80px; }  /* SKU */
.table th:nth-child(2) { min-width: 200px; } /* Name */
.table th:nth-child(3) { min-width: 120px; } /* Manufacturer */
.table th:nth-child(4) { min-width: 100px; } /* MPN */
.table th:nth-child(5) { min-width: 120px; } /* Category */
.table th:nth-child(6) { min-width: 100px; } /* EAN */
.table th:nth-child(7) { min-width: 80px; }  /* Retail inc */
.table th:nth-child(8) { min-width: 80px; }  /* Trade inc */
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-data__tool">
                    <!-- Left side - Add New Item button -->
                    <div class="table-data__tool-left">
                        <?php if ($user_details['admin'] != 0): ?>
                        <button class="btn btn-success btn-xs" id="newItemBtn"><i class="zmdi zmdi-plus"></i> Add</button>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="table-data__tool-right">
                        <div class="form-check">
                            <label for="enabledProducts" class="form-check-label">
                                <input type="checkbox" id="enabledProducts" value="enabled" class="form-check-input filterRecords" checked> Active
                            </label>
                        </div>
                        <div class="form-check">
                            <label for="exportToMagento" class="form-check-label">
                                <input type="checkbox" id="exportToMagento" value="enabled" class="form-check-input filterRecords"> WWW
                            </label>
                        </div>
                        <?php if ($user_details['admin'] != 0): ?>
                        <div class="form-check">
...
document.getElementById('exportToCsv')?.addEventListener('click', function () {
    ...
    const exportToMagento = document.getElementById('exportToMagento').checked ? 1 : 0;
...
$(document).on('keypress', '#newItemForm, #updateDetailsForm', function(e) {
    ...
    $(document).on('submit' , '.jumpToPageForm' , function(e){
      ...
      var form = $(this) ,
        ...
        lastPage = form.finlastPage = form.find(".jumpToPage").attr("data-last_page"),
  ...
  $("#exportToMagento").click(function() {
    var searchQuery = $("#searchQuery").val(),
        ...
        exportToMagento = $("#exportToMagento")[0].checked ? 1 : 0;
