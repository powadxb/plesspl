...
// Function to show session selection dialog - FIXED VERSION
    // Replace the showSessionSelectionDialog function with this fixed version:
            ...
            success: function(response) {
                ...
                try {
                    ...
                    if (result.success) {
                        ...
                        Swal.fire('Error', 'Failed to add items to queue', 'error');
                    }
                } catch (e) {
                    Swal.fire('Error', 'Invalid response from server', 'error');
                }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                try {
                    ...
                    Swal.fire('Error', 'Server response was not valid JSON: ' + response, 'error');
                }
            },
            error: function() {
                $("#spinner").hide();
