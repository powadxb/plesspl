...
<div class="pc-quote-container">
    ...
    <div class="quote-grid">
        ...
        <div class="components-column">
            ...
            <div class="component-section">
                ...
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select CPU...">
            ...
            <div class="component-section">
                <label>Cooler</label>
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select Cooler...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
            ...
            <div class="component-section">
                <label>RAM</label>
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select RAM...">
            ...
            <div class="component-section">
                ...
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select Graphics Card...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
            ...
            <div class="component-section">
                ...
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select Motherboard...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
            ...
            <div class="component-section">
                <label>PSU</label>
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select Power Supply...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
            ...
            <div class="component-section">
                <label>Case</label>
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select Case...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
        ...
        <div class="components-column">
            ...
            <div class="component-section">
                <label>SSD 1</label>
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select Primary Storage...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
            ...
            <div class="component-section">
                <label>SSD 2</label>
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select Secondary Storage...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
            ...
            <div class="component-section">
                <label>SSD 3</label>
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select Additional Storage...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
            ...
            <div class="component-section">
                <label>WiFi</label>
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select WiFi...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
            ...
            <div class="component-section">
                ...
                <div class="component-input">
                    <input type="text" readonly class="form-control form-control-sm" placeholder="Select OS...">
                    <button class="btn btn-sm btn-primary btn-search">🔍</button>
                    <button class="btn btn-sm btn-success btn-manual">+</button>
                </div>
                <div class="component-details"></div>
    ...
    <div class="totals-section">
        <div class="totals">
            ...
            <?php if ($is_admin): ?>
            <span class="profit">Profit: £<span id="totalProfit">0.00</span></span>
            <?php endif; ?>
        </div>
        <div class="actions">
            <button id="saveQuoteBtn" class="btn btn-success btn-sm">Save Quote</button>
            <button id="printQuoteBtn" class="btn btn-primary btn-sm">Print</button>
            <button id="createOrderBtn" class="btn btn-warning btn-sm">Create Order</button>
        </div>
    </div>
</div>
