    ...
    <div class="col-sm-4" style="border-right: 3px solid #007bff;">
      ...
      <div class="form-group">
        <select id="u-categories" name="categories" class="form-control dropDownMenu requiredField">
          <option value="" <?=empty($details['category_id'])?'selected':''?>>Select Category</option>
      ...
      <div class="form-check">
        <div class="checkbox">
          <label for="u-enable" class="form-check-label">
      ...
      <div class="form-check">
        <div class="checkbox">
          <label for="u-export_to_magento" class="form-check-label">
      ...
      <div class="form-check">
        <div class="checkbox">
          <label for="u-stock_status" class="form-check-label">
            <input type="checkbox" id="u-stock_status" name="stock_status" value="1" class="form-check-input" <?=($details['stock_status']==1)?'checked':''?>> In Stock
          </label>
        </div>
      </div>
      <div class="form-check">
        <div class="checkbox">
          <label for="u-on_pos" class="form-check-label">
    ...
    <div class="col-sm-8">
      ...
      <div class="row ml-0 mr-0">
        ...
        <div class="form-group col-sm-4">
          ...
          <input type="text" id="u-targetTrade" name="target_trade" class="form-control bg-secondary text-white whitePlaceholder calculationField doCalculations targetTrade" placeholder="Target Trade Inc Vat"  >
