...
try {
    ...
    // Set enable, export_to_magento, and stock_status flags
    ...
    $response = $DB->query("INSERT INTO master_products (name, manufacturer, mpn, ean, category_id, pless_main_category, pos_category, supplier, enable, export_to_magento, stock_status, cost, pricing_cost, pricing_method, tax_rate_id, retail_markup, trade_markup, fixed_retail, fixed_trade, price, trade) 
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", 
                            [$_POST['name'], $_POST['manufacturer'], $_POST['mpn'], $_POST['ean'], $category_id, $pless_main_category, $pos_category, $_POST['supplier'], $enable, $export_to_magento, $stock_status, $_POST['cost'], $_POST['pricing_cost'], $_POST['pricing_method'], $_POST['tax_rate_id'], $_POST['retail_markup'], $_POST['trade_markup'], $fixed_retail_pricing, $fixed_trade_pricing, $price, $trade]);
